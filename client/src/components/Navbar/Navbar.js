    ...
    <nav className='navbar'>
      <div className='navbar-cnt flex align-center'>
        ...
        <div className='navbar-collapse w-100'>
          <ul className='navbar-nav flex align-flex-end fs-20 fw-7 font-manrope'
            style={{ marginLeft: '900px', marginTop: '10px' }}>
            <li >
              <Link to="/registration">
                <span className='top-link-itm-txt'>Register</span>
              </Link>
            </li>
            <li className='vert-line' style={{ marginTop: '10px' }}></li>
            <li>
              <Link to="/login">
          ...
          <div className="d-flex" style={{ textAlign: 'center', marginTop: '-35px' }}>
            <div className='form-control me-2 '>
              ...
              <Link to={`search/${searchTerm}`} className="search-btn justify-center"  >
                <i className='fa-solid fa-magnifying-glass' style={{ marginLeft: '10px',color:'white' }}></i>
              </Link>
            </div>
          </div>
